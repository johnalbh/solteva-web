...
export async function generateMetadata({ params }: Props) {
  ...
  return generateSEOMeta({
    ...
    description:
      locale === "es"
        ? "Plataformas salvaescaleras para escaleras rectas y curvas. Ideales para sillas de ruedas. Visita gratuita en 24h. 900 100 133."
        : "Platform lifts for straight and curved staircases. Ideal for wheelchairs. Free visit in 24h. 900 100 133.",
    locale,
